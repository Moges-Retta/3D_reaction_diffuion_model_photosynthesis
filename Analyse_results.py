...
The net photosynthesis rate is calculated: 
    by integrating the flux across the leaf surface
    using the biochemical model and calculating the concentration of gases
If the two methods' photosynthesis values agree, the solution has converged.

Inputs

data : leaf geometrical model
air : domain of the external air in the 3D geometry
J_vol : ATP production rate (umol/m3/s)
J_vol_NADPH : NADPH production rate (umol/m3/s)
J_vol_PEP : ATP available for PEP regeneration (umol/m3/s)
u_CO2 : CO2 concentration (umol/mol)
u_O2 : O2 concentration (umol/mol)
u_HCO3 : HCO3 concentration (umol/mol)
p_para : list of parameters of the model

Outputs

A_flux: total CO2 flux across the leaf surfaces (umol/m2/s)
A_net : net photosynthesis rate (umol/m2/s)
Ac_r : Rubisco-limited rate of carboxylation (umol/m2/s)
Aj_r : electron-transport-limited rate of carboxylation (umol/m2/s)
Cc : mean [CO2] in the bundle-sheath chloroplast (umol/mol)
Ci : mean [CO2] in the intercellular airspace (umol/mol)
Cm : mean [CO2] in the mesophyll cytosol (umol/mol)
gm : mesophyll conductance (mol/m2/s)
gs : stomatal conductance (mol/m2/s)
gbs : bundle-sheath conductance (mmol/m2/s)
L : CO2 leakage flux (umol/m2/s)
O2c : mean [O2] in the bundle-sheath chloroplast (umol/mol)
O2m : mean [O2] in mesophyll cytosol (umol/mol)
rp : rate of photorespiration (umol/m2/s)
Vp : rate of PEP carboxylation (umol/m2/s)
Vpc_r : PEP carboxylase limited rate of Vp (umol/m2/s)
Vpj_r : PEP regeneration limited rate of Vp (umol/m2/s)

The components of the 3-D geometry are identified using indices
